...
type RacingClient interface {
	...
	GetRaceById(ctx context.Context, in *GetRaceByIdRequest, opts ...grpc.CallOption) (*Race, error)
}
...
func (c *racingClient) GetRaceById(ctx context.Context, in *GetRaceByIdRequest, opts ...grpc.CallOption) (*Race, error) {
	out := new(Race)
...
type RacingServer interface {
	...
	// GetRacesById returns a specific race by its id.
	GetRaceById(context.Context, *GetRaceByIdRequest) (*Race, error)
...
func (UnimplementedRacingServer) GetRaceById(context.Context, *GetRaceByIdRequest) (*Race, error) {
